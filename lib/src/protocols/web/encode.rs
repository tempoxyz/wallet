...
///
/// ```no_run
/// # use purl_lib::protocols::web::{PaymentChallenge, PaymentMethod, PaymentIntent};
...
/// };
///
/// let header = purl_lib::protocols::web::format_www_authenticate(&challenge)?;
...
///
/// ```no_run
/// # use purl_lib::protocols::web::{PaymentCredential, PaymentPayload, PayloadType};
...
/// };
///
/// let header = purl_lib::protocols::web::format_authorization(&credential)?;
...
///
/// ```no_run
/// # use purl_lib::protocols::web::{PaymentReceipt, PaymentMethod, ReceiptStatus};
...
/// };
///
/// let header = purl_lib::protocols::web::format_receipt(&receipt)?;
