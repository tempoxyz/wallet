...
//!
//! ```no_run
//! # use purl_lib::protocols::web::{PaymentChallenge, PaymentCredential, PaymentMethod, PaymentIntent};
...
//! let challenge = purl_lib::protocols::web::parse_www_authenticate(header)?;
//!
...
//! #     id: "abc123".to_string(),
//! #     source: None,
//! #     payload: purl_lib::protocols::web::PaymentPayload {
//! #         payload_type: purl_lib::protocols::web::PayloadType::Transaction,
//! #         signature: "0x...".to_string(),
//! #     },
//! # };
//! let auth_header = purl_lib::protocols::web::format_authorization(&credential)?;
//! # Ok(())
//! # }
//! ```
