...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn it31_top_up_challenge_not_found_refreshes_via_head_and_retries() {
    let rpc = SessionRpcServer::start().await;
    let server = SessionServer::start(SessionServerConfig {
        payee_mode: PayeeMode::Fixed,
        open_receipt_accepted: None,
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn it32_voucher_head_success_does_not_fallback_to_post() {
    let rpc = SessionRpcServer::start().await;
    let server = SessionServer::start(SessionServerConfig {
        payee_mode: PayeeMode::Fixed,
        open_receipt_accepted: None,
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn it33_failure_response_payment_receipt_is_not_treated_as_success() {
    let rpc = SessionRpcServer::start().await;
    let server = SessionServer::start(SessionServerConfig {
        payee_mode: PayeeMode::Fixed,
        open_receipt_accepted: None,
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn it34_stream_on_a_and_submit_voucher_top_up_on_b_same_handler() {
    let rpc = SessionRpcServer::start().await;
    let server = SessionServer::start(SessionServerConfig {
        payee_mode: PayeeMode::Fixed,
        open_receipt_accepted: None,
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn it35_new_session_while_prior_stream_active_recovers_without_state_corruption() {
    let rpc = SessionRpcServer::start().await;
    let server = SessionServer::start(SessionServerConfig {
        payee_mode: PayeeMode::Fixed,
        open_receipt_accepted: None,
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn it36_fee_payer_true_and_false_paths_cover_open_and_top_up_flows() {
    let rpc = SessionRpcServer::start().await;
    let server = SessionServer::start(SessionServerConfig {
        payee_mode: PayeeMode::Fixed,
        open_receipt_accepted: None,
