...
//!
//! Production code uses only `format_u256_with_decimals`. The `TokenId` and
//! `Money` types live inside the test module where they provide type-safe
//! arithmetic for verifying payment logic.
