...
Browser-based WebAuthn wallet created via Tempo's passkey flow (`wallet/passkey.rs`). Authentication is delegated to the browser;  tempo-walletstores the resulting wallet address and key authorization.
