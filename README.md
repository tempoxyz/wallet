...
presto collects anonymous usage analytics (via PostHog) to help improve the tool. No personal data, API keys, request bodies, or wallet private keys are ever collected.
