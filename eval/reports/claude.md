...
| neg-internal-api | trigger-negative | ❌ | ✅ | ❌ FAIL | 16.8s | 4 | presto invoked but should not have been (1 calls) |
...
**Reasons:**
- presto invoked but should not have been (1 calls)

**Presto calls:** 1 | **Curl calls:** 0
